...
public class ItemLog implements CalorieCounter, Loadable {
    ...
    public ArrayList<Item> getListToRemove() {
        return listToRemove;
    }

    public ItemDone getFoodEaten() {
        return foodEaten;
    }

    public ItemDone getExerciseDone() {
        return exerciseDone;
    }
...
//    }
    ...
    //         throws NotAnItemException if item is not found
    public ItemList search(String input) {
